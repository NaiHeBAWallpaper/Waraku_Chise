...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/Blooming moon.flac';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	{
		...
		dialog: {
			Japanese: [
				"ようこそ、先生。",
				"ここは静かだから…俳句を作るのにちょうど良くて。"
			],
			English: [
				"Welcome, Sensei.",
				"It's quiet here... Perfect for writing a haiku."
			],
			Chinese: [
				"老师，快来。",
				"这里很安静...很适合写俳句。"
	...
	},
	{
		time: 33000,
		count: 4,
		startTimes: [500, 10100, 15600, 22700],
		dialog: {
			Japanese: [
				"今日は先生と一緒で…すごく楽しかった。",
				"それで私、気づいたの。",
				"私が作りたかった俳句、それは…。",
				"今日ずっと感じていたこの気持ちを、込めたものだったんだって。"
			],
			English: [
...
const HITBOX = {
	headpat: { xMin: 1580, xMax: 2050, yMin: 140, yMax: 380 },
	voiceline: { xMin: 1320, xMax: 2200, yMin: 700, yMax: 1600 }
};
